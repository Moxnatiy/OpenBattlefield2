...
//   32, 32, 32             місце солдата, три числа
//   16, 1 ...              далі йде решта стану, яку ми ще не розбирали
//
// Нам вистачає початку: саме звідти беремо, де ми стоїмо. Решту функції
// (а вона довга й розгалужена) лишаємо на потім — тому й записи привидів
// у таких пакетах поки не читаємо: без повного розбору невідомо, де вони
// починаються.
