...
//
// **Трійка чисел — це опорна точка стиснення.** Перед нею стоїть
// `BitStream::resetCompressionVector`, а одразу після — `setCompressionVector`
// із нею ж (0x445cf7 і 0x445d4b). Тобто далі в потоці вектори пишуться як
// різниця до цієї точки. Заразом вона і є місцем солдата — саме тому вона
// й опорна.
//
