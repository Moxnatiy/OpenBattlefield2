...
1. **misc** — MD5 по `.con`-файлах мода
   (`ChecksumContext::runMiscChecksum`; у налагоджувальному складанні
   він друкує «dep: hashing misc con files» і далі «dep: checksumming
   file» на кожен файл). Обидва боки рахують його самі; який саме набір
   файлів — ще не з'ясовано;
