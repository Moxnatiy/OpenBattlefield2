...
- HUD розбирається, але ще не малюється: 1615 вузлів у дереві, 1574 команди
  `hudBuilder` без обробника.
- Сервер поки лише роздає початковий стан світу: немає ані руху об'єктів,
  ані вводу гравця, ані UDP-каналу (тільки петля в пам'яті).
