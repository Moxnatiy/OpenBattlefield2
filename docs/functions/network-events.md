...
гілкою **відмови 27**. Тобто позначка `contentValid` так і не виставлена,
хоча порівняння хешів проходить (точка зупину на гілці збігу
спрацьовує). Отже або збіг першого хеша ще не означає успіху, або
позначка ставиться не там, де ми її шукаємо.
