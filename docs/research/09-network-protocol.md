...
```
рівень dalian_plant: відомих об'єктів 75
об'єктів від сервера: 50, зіставлено: 40
    ...
    ...
не впізнано 3 номерів:
      47  @ -701.0 184.6 -350.0
    3747  @ -216.0 154.4 -326.8
    3751  @ -797.7 184.8 -140.8
```
...
Три номери лишилися невпізнаними: у нашій таблиці рівня таких точок
немає. Це вже підказка, чого нам бракує в читанні рівня, а не хиба
калібрування.
