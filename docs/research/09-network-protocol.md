...
Зіставити номери шаблонів із назвами. Найдешевший шлях — калібрування за
позиціями: наш рушій уже читає рівень, тож знає, що і де стоїть на
dalian_plant, а сервер каже номери для тих самих місць. З цього виходить
таблиця «номер -> назва», яку далі можна звірити з порядком завантаження.
Після цього — потік привидів, тобто рух.
